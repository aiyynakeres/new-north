...
const Landing: React.FC = () => (
  <div className="min-h-[calc(100vh-64px)] flex flex-col items-center justify-center text-center px-4 relative overflow-hidden bg-cover bg-center bg-no-repeat bg-[url('/background.jpg')]">
    <div className="absolute inset-0 bg-black/20 -z-10"></div>
    <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-blue-100/30 rounded-full blur-3xl -z-10"></div>
    <div className="absolute bottom-1/4 right-1/4 w-64 h-64 bg-slate-200/30 rounded-full blur-3xl -z-10"></div>
    ...
    {/* <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl w-full text-left">
      <div className="p-6 bg-white rounded-2xl border border-north-100 shadow-sm">
        ...
        <h3 className="font-serif font-bold text-lg mb-2">Делись своими знаниями</h3>

      ...
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-north-600 text-sm leading-relaxed max-w-xl">
            Здесь можно создать своё сообщество, посмотреть существующие группы, подписаться на интересные и публиковать
            посты внутри клубов.
          </p>
        </div>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
          ...
          >
            <div className="flex items-center justify-between px-5 py-4 border-b border-north-100">
              <h2 id="create-community-title" className="font-serif text-xl font-bold text-north-900">
                Новое сообщество
              </h2>
              <button
                type="button"
            ...
            <div className="p-5 space-y-4">
              <p className="text-sm text-north-500">
                Укажите название и описание: краткое — для карточек и списков, подробное — на странице сообщества. После
                создания вы станете создателем и сможете назначать админов.
              </p>
              <div>
                <label className="block text-sm font-medium text-north-700 mb-1">Название</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-north-700 mb-1">Кратко о сообществе</label>
                <textarea
              ...
              <div>
                <label className="block text-sm font-medium text-north-700 mb-1">Подробное описание</label>
                <textarea
                  className="w-full px-3 py-2 rounded-lg border border-north-200 text-sm resize-none focus:outline-none focus:ring-2 focus:ring-north-400"
                  rows={4}
                  value={description}
